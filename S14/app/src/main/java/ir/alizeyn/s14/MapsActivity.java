...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(getMarker(sydney));
    ...
    public MarkerOptions getMarker(LatLng loc) {
    ...
    LocationListener locationListenerGps = new LocationListener() {
        public void onLocationChanged(Location location) {
            ...
            mMap.addMarker(getMarker(myLocation));
    ...
    public void case2(View view) {
        ...
        if (gpsEnabled)
            lm.requestLocationUpdates(LocationManager.GPS_PROVIDER, 200, 6, locationListenerGps);
        if (networkEnabled)
            lm.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 200, 6, locationListenerGps);
